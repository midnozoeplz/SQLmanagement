 ...
 **/
// 用户管理-获取用户列表
export const userProductList = (params) => { return req("get", ""+params+"/product/getList", params) };
export const addOrupdateProduct = (userProduct) => { return req("post", "/product/addToShopping",userProduct) };
export const productDelete = (params,productId) => { return req("post","/" + params + "/product/deleteProduct?productId=" + productId,params) };
export const productList = (params) => { return req("get", "/product/list?page="+params.page+"&limit="+params.limit) };
export const addOrUpdate = (product) => { return req("post", "/product/addOrUpdate",product) };
export const deleteProduct = (id) => { return req("post", "/product/delete?id="+ id) };
export const addUserProduct = (userProduct) => { return req("post", "/product/addToShopping",userProduct) };
export const addCastOrder = (userid,productIdList) => { return req("post", "/product/addCastOrder?userid=" +userid + "&productIdList=" +productIdList) };
export const getOrderList = (params) => { return req("get", "/product/getOrderList?userid=" +params) };
