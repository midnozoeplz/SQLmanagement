<template>
  <div class="login-wrap">
    <el-form label-position="left" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="0px" class="demo-ruleForm login-container">
      ...
      <el-link class="p1" type="primary" href="http://localhost:8888/#/register">注册账号</el-link> 
      ...
      var user = {
        ...
        login(user).then(res =>{
            ...
            if (res.code != '401 UNAUTHORIZED') {
              ...
              var token = res.result.result.token
              var userid = res.result.result.userid
              var role = res.result.result.role
            ...
            this.$router.push({ path: '/system/shopping' })
          }, 1000)  
            }else{
               this.$message({
                 message: '用户名密码错误',
